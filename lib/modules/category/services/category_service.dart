...
class CategoryService {
  ...
  CategoryModel _mockNegocios() {
    var question = new QuestionModel(
        ...
        hintText: '');
    var question2 = new QuestionModel(
        id: 10, title: 'Como você consegue os seus clientes?', hintText: '');
    var question3 =
        new QuestionModel(id: 11, title: 'Quem é o seu cliente?', hintText: '');
    var item = CategoryModel(id: 2, title: 'Negocios', questions: [
      question,
      question2,
      question3,
    ]);
  ...
  CategoryModel _mockRealizacao() {
    var question = new QuestionModel(
        id: 12, title: 'Qual será o primeiro passo?', hintText: '');
    var question2 = new QuestionModel(
        id: 13, title: 'Qual será o primeiro teste?', hintText: '');
    var question3 =
        new QuestionModel(id: 14, title: 'Quando você começa?', hintText: '');
    var question4 =
        new QuestionModel(id: 15, title: 'Quem pode te ajudar?', hintText: '');
    var item = CategoryModel(id: 3, title: 'Realização', questions: [
      question,
      question2,
      question3,
      question4,
  ...
  CategoryModel _mockPessoal() {
    var question =
        new QuestionModel(id: 16, title: 'Porque você quer isso?', hintText: '');
    var question2 = new QuestionModel(
        id: 17, title: 'O que você pode aprender com essa ideia?', hintText: '');
    var question3 = new QuestionModel(
        id: 18, title: 'Será divertido trabalhar nisso?', hintText: '');
    var item = CategoryModel(id: 4, title: 'Pessoal', questions: [
      question,
      question2,
      question3,
    ]);
  ...
  CategoryModel _mockTolice() {
    ...
    var question6 = new QuestionModel(
        ...
        hintText: '');
    var item = CategoryModel(id: 5, title: 'Tolice', questions: [
      question,
      question2,
      question3,
      question4,
  ...
  CategoryModel _mockSociedade() {
    var question =
        new QuestionModel(id: 25, title: 'Quem será beneficiado?', hintText: '');
    var question2 =
        new QuestionModel(id: 26, title: 'Quem vai pagar?', hintText: '');
    var question3 = new QuestionModel(
        id: 27, title: 'Quando é considerado um sucesso?', hintText: '');
    var item = CategoryModel(id: 6, title: 'Sociedade', questions: [
      question,
      question2,
      question3,
    ]);
